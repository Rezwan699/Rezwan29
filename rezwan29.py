...
import os,sys
try: import requests
except ModuleNotFoundError:print("Rezwan Install Module requests");os.system("python -m pip install requests &> /dev/SIAM")
try: import bs4
except ModuleNotFoundError:print("Rezwan Install Module bs4");os.system("python -m pip install bs4 &> /dev/SIAM")
try: import mechanize
except ModuleNotFoundError:print("Rezwan Install Module mechanize");os.system("python -m pip install mechanize &> /dev/SIAM")
try: import gTTS
...
def line_chack_dote():
	...
	for b in range(2):
		for t in m:
				sys.stdout.write("\[*] Creating TNL Internet File " + t)
	sys.stdout.flush()
	time.sleep(0.1)
...
def main_apv():
    ...
    try:
        ...
        print ("[*]--------------------------------------------------------------")
        time.sleep(6)
        os.system("xdg-open https://https://www.facebook.com/Rezwan.Chowdhury69")
